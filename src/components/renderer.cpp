...
//     return (v + byteAlign - 1) & ~(byteAlign - 1);//~NOT
// }

// Renderer::Renderer(Vkview *w, int initialCount)
//     :vkview(w),
//     lightPos(0.0f, 0.0f, 25.0f),
//     cam(QVector3D(0.0f, 0.0f, 20.0f)),
//     instCount(initialCount){
//     floorModel.translate(0, -5, 0);
//     floorModel.rotate(-90, 1, 0, 0);
//     floorModel.scale(20, 100, 1);

//     blockMesh.load(QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/shared/block.buf"));
//     logoMesh.load(QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/shared/qt_logo.buf"));
...
//     itemMaterial.vertUniSize = aligned(2 * 64 + 48, uniAlign);
//     itemMaterial.fragUniSize = aligned(6 * 16 + 12 + 2 *4, uniAlign);

//     if(itemMaterial.vs.isValid())
//         itemMaterial.vs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_phone_vert.spv"));
//     if(itemMaterial.fs.isValid())
//         itemMaterial.fs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_phone_frag.spv"));
//     if(floorMaterial.vs.isValid())
//         floorMaterial.vs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_vert.spv"));
//     if(floorMaterial.fs.isValid())
//         floorMaterial.fs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_frag.spv"));
...
void Renderer::initResources()
{
    ...
    if (!itemMaterial.vs.isValid())
        itemMaterial.vs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_phong_vert.spv"));
    if (!itemMaterial.fs.isValid())
        itemMaterial.fs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_phong_frag.spv"));
    if (!floorMaterial.vs.isValid())
        floorMaterial.vs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_vert.spv"));
    if (!floorMaterial.fs.isValid())
        floorMaterial.fs.load(inst, dev, QStringLiteral("E:/Works/Qt/Examples/Qt-6.7.2/vulkan/hellovulkancubes/color_frag.spv"));
